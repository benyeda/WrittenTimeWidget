...
public class AlarmManagerBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        PowerManager.WakeLock wl = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "mytag:tag");
        //Acquire the lock
        wl.acquire();
        ...
        String time = Utility.getCurrentTimeInHungarian();//Utility.getCurrentTime("hh:mm:ss a");
